...
namespace Drupal\mensajes\ContextProvider;
...
class MessagesContext implements ContextProviderInterface {
  ...
  protected function getMessages(): ?array {
    ...
    return is_null($this->messages) ? $this->messenger()->deleteAll() : $this->messages;
  }
